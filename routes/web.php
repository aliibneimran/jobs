...
Route::get('/jobs-datails', [JobDetailsController::class, 'index'])->name('jobs-details');
Route::get('/about', [AboutController::class, 'index'])->name('about');
Route::get('/contact', [ContactController::class, 'index'])->name('contact');
Route::get('/signin', [FrontendCandidateController::class, 'index'])->name('signin');
Route::get('/signup', [FrontendCandidateController::class, 'signup'])->name('signup');
