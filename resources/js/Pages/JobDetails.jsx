          ...
          <div className="row">
            <div className="col-lg-8 col-md-12 col-sm-12 col-12">
              <div className="box-border-single">
                ...
                <div className="banner-hero banner-image-single mt-10 mb-20"><img src="frontend/imgs/page/job-single-2/img.png" alt="jobBox" /></div>
            ...
            <div className="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
              <div className="sidebar-border">
                <div className="sidebar-heading">
                  <div className="avatar-sidebar">
                    <figure><img alt="jobBox" src="frontend/imgs/page/job-single/avatar.png" /></figure>
                    <div className="sidebar-info"><span className="sidebar-company">AliThemes</span><span className="card-location">New York, US</span><a className="link-underline mt-15" href="#">02 Open Jobs</a></div>
                  </div>
                </div>
                  ...
                  <ul>
                    <li>
                      <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div className="image"><a href="job-details.html"><img src="frontend/imgs/brands/brand-1.png" alt="jobBox" /></a></div>
                    ...
                    <li>
                      <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div className="image"><a href="job-details.html"><img src="frontend/imgs/brands/brand-2.png" alt="jobBox" /></a></div>
                        <div className="info-text">
                    ...
                    <li>
                      <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div className="image"><a href="job-details.html"><img src="frontend/imgs/brands/brand-3.png" alt="jobBox" /></a></div>
                        <div className="info-text">
                    ...
                    <li>
                      <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div className="image"><a href="job-details.html"><img src="frontend/imgs/brands/brand-4.png" alt="jobBox" /></a></div>
                        <div className="info-text">
                    ...
                    <li>
                      <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div className="image"><a href="job-details.html"><img src="frontend/imgs/brands/brand-5.png" alt="jobBox" /></a></div>
                        <div className="info-text">
                    ...
                    <li>
                      <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div className="image"><a href="job-details.html"><img src="frontend/imgs/brands/brand-6.png" alt="jobBox" /></a></div>
                        <div className="info-text">
                    ...
                    <li>
                      <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div className="image"><a href="job-details.html"><img src="frontend/imgs/brands/brand-7.png" alt="jobBox" /></a></div>
                        <div className="info-text">
                    ...
                    <li>
                      <div className="card-list-4 wow animate__animated animate__fadeIn hover-up">
                        <div className="image"><a href="job-details.html"><img src="frontend/imgs/brands/brand-8.png" alt="jobBox" /></a></div>
                        <div className="info-text">
              ...
              <div className="sidebar-border">
                ...
                <div className="sidebar-list-job"><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">App</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">Digital</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">Marketing</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">Conten Writer</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">Sketch</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">PSD</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">Laravel</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">React JS</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">HTML</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">Finance</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">Manager</a><a className="btn btn-grey-small bg-14 mb-10 mr-5" href="jobs-grid.html">Business</a></div>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="swiper-slide">
                    <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                      ...
                      <div className="card-block-info">
                        ...
                        <div className="mt-30"><a className="btn btn-grey-small mr-5" href="job-details.html">PHP</a><a className="btn btn-grey-small mr-5" href="job-details.html">Android  </a></div>
                        <div className="card-2-bottom mt-30">
                          <div className="row">
                            <div className="col-lg-7 col-7"><span className="card-text-price">$800</span><span className="text-muted">/Hour</span></div>
                            <div className="col-lg-5 col-5 text-end"><a className="btn btn-apply-now" href="job-details.html">Apply now</a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="swiper-slide">
                    <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                      ...
                      <div className="card-block-info">
                        ...
                        <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                        <div className="mt-30"><a className="btn btn-grey-small mr-5" href="jobs-grid.html">Typescript</a><a className="btn btn-grey-small mr-5" href="jobs-grid.html">Java</a></div>
                        <div className="card-2-bottom mt-30">
                          <div className="row">
                  ...
                  <div className="swiper-slide">
                    <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                      ...
                      <div className="card-block-info">
                        ...
                        <div className="mt-5"><span className="card-briefcase">Full time</span><span className="card-time">6<span> minutes ago</span></span></div>
                        <p className="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                        <div className="mt-30"><a className="btn btn-grey-small mr-5" href="job-details.html">iOS</a><a className="btn btn-grey-small mr-5" href="job-details.html">Laravel</a><a className="btn btn-grey-small mr-5" href="job-details.html">Golang</a></div>
                        <div className="card-2-bottom mt-30">
                          <div className="row">
                            <div className="col-lg-7 col-7"><span className="card-text-price">$250</span><span className="text-muted">/Hour</span></div>
                            <div className="col-lg-5 col-5 text-end"><a className="btn btn-apply-now" href="job-details.html">Apply now</a></div>
